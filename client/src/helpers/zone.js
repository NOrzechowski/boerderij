...
export default class Zone {
    constructor(scene) {
        ...
        this.renderBaseCards = () => {
            ...
            card.renderFixed(475, 350, 'jack_clubs');
            card.renderFixed(675, 350, 'queen_diamonds');
            card.renderFixed(875, 350, 'king_hearts');
            card.renderFixed(1075, 350, 'ace_spades');
            card.renderFixed(475, 250, 'slot_clubs_hi')
            card.renderFixed(475, 250, 'slot_clubs_hi')
        }
